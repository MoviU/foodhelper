        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            <div class="inner">
              ...
              <p>{{ __('Количество ресторанов') }}</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="{{ route('places.index') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-warning">
            <div class="inner">
              ...
              <p>{{ __('Зарегитрированных пользователей') }}</p>
            </div>
            <div class="icon">
